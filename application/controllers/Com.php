...
class Com extends Main
{
      ...
      function index()
    {
        ...
        $pag['base_url'] = site_url('com/index');
        $pag['total_rows'] = $this->com->count_all($this->get_current_city()->id);
        ...
        $data['feeds'] = $this->com->get_all($this->get_current_city()->id, $pag['per_page'], $this->uri->segment(3));
        $data['pag'] = $pag;
        $content['content'] = $this->load->view('com/list',$data,true);
