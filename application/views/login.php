            ...
            <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                <div class="d-table-cell align-middle">
                    ...
                    <div class="text-center mt-4">
                        ...
                        <p class="lead">
                            Connectez-vous pour continuer a  gerer votre Station
                        </p>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="m-sm-4">
                                ...
                                <div class="input-group input-group-lg mb-3">
                                    ...
                                    <input type="text" class="form-control" id="validation-email"  name="pseudo" placeholder="Entrez votre numero de telephone valide" required autocomplete="off">
                                ...
                                <div class="input-group input-group-lg mb-3">
                                    ...
                                    <input type="password" class="form-control" id="validation-password" name="password" placeholder="Entrez votre Mot de passe valide" required>
                                </div>
