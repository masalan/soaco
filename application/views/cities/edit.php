	...
	?>
		...
		<a href="<?php echo site_url('commune');?>" class="btn btn-primary">Annuler</a>
	</form>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Remplacer l`image de couverture</h4>
				</div>
				<?php
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Suppression de l`image de couverture</h4>
				</div>
				<div class="modal-body">
					<p>Etes-vous sure de vouloir supprimer l`image de couverture?</p>
				</div>
				<div class="modal-footer">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Suppression de la Departement</h4>
				</div>
				<div class="modal-body">
					<p>Etes-vous sure de vouloir supprimer la Departement car elle entrainera la suppression automatique de:</p>
					<p>1. Commune</p>
					<p>2. Arrondissement</p>
					<p>3. Station</p>
					<p>4. Message, Like,commentaire etc</p>
					<p>6. Statistique</p>
				</div>
				<div class="modal-footer">
