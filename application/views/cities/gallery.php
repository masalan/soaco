...
<noscript><link rel="stylesheet" href="<?php echo base_url('assets/css/jquery.fileupload-ui-noscript.css');?>"></noscript>
	...
	<ul class="breadcrumb">
		<li><a href="<?php echo site_url('cities');?>">Cities List</a> <span class="divider"></span></li>
		<li><a href="<?php echo site_url("cities/edit/".$id);?>">Edit City</a> <span class="divider"></span></li>
		<li>Gallery</li>
	</ul>
