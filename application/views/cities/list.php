...
<!--												<a href="--><?php //echo site_url('profile');?><!--" class="btn btn-sm active">Edit Profile</a>-->
									...
									<div class="navbar-footer">
										<div class="navbar-footer-content">
											<div class="row">
												<div class="col-md-6">
													<a href="<?php echo site_url('profile');?>" class="btn btn-sm" style="background-color: #fff; border-radius: 0;">Modifier</a>
												</div>
												<div class="col-md-6">
													<a href="<?php echo site_url('logout');?>" class="btn btn-sm pull-right" style="background-color: #fff; border-radius: 0;">Sortir</a>
												</div>
											</div>
										</div>
									</div>
				...
				<div class="col-md-12 text-center">
					...
					?>
					  <div class="form-group">
					    <label class="sr-only" for="cityname">Nom Commune</label>
					  ...
					  <a class="btn btn-primary" href="<?php echo site_url('creer/commune');?>">
					  ...
					  <a class="btn btn-primary" href="<?php echo site_url('commune/nonvalide');?>">
...
<!--					  </a>-->
					  ...
					  <a class="btn btn-primary" href="<?php echo site_url('apropos');?>">
					  	<span class='fa fa-info-circle'></span> &nbsp; A propos de nous
					  </a> 	
					<?php endif; ?>
					...
					<div class="ibox float-e-margins">
					        ...
					        <div>
					            <div class="ibox-content no-padding border-left-right">
					                <a href="<?php echo site_url('manager/'.url_encode($city->id));?>">
						                <?php
						                	echo "<img  alt='".$city->name."' class='img-responsive' src='".base_url('uploads/'.$city->image)."'/>";
						                ?>
					                </a>
					            </div>
					            <div class="ibox-content profile-content">
					                ...
					                <h5>
					                    <strong>A propos de <?php echo $city->name; ?></strong>
					                </h5>
					                <p>
					                    <?php 
					                    	...
					                    	if (strlen($cityDesc) >100) {
					                    	
					                    	    $stringCut = substr($cityDesc, 0, 100);
					                ...
					                <div class="row m-t-lg">
					                    ...
					                    <div class="col-md-4">
					                        <span class="bar">5,3,9,6,5,9,7,3,5,2</span>
					                        <p><?php echo $this->item->count_all($city->id) ?> Stations</p>
					                    </div>
					                    <div class="col-md-4">
					                        <span class="bar">5,3,9,6,5,9,7,3,5,2</span>
					                        <p><?php echo $this->inquiry->count_all($city->id) ?> Messages</p>
					                    </div>
					                </div>
					                <div class="user-button">
					                    <div class="row">
					                        <a href="<?php echo site_url('manager/'.url_encode($city->id));?>">
					                        	<button type="button" class="btn btn-primary btn-sm btn-block"><i class="fa fa-dashboard" style="padding-right: 5px;"></i><?php echo $this->lang->line('dashboard_label'); ?> de  <?php echo $city->name; ?></button>
					                        </a>
					                    </div>
					                </div>
					            </div>
