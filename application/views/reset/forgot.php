...
<head>
    ...
    <title>Réinitialiser mot de passe | SOACO e-Station</title>
            ...
            <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                <div class="d-table-cell align-middle">
                    ...
                    <div class="text-center mt-4">
                        <h1 class="h2">Réinitialiser mot de passe</h1>
                        <p class="lead">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="m-sm-4">
                                ...
                                echo form_open(site_url('login_station/forgot'), $attributes);
                                ?>                                    <div class="input-group input-group-lg mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="ion ion-ios-mail mr-2"></i></span>
                                        </div>
                                        <input type="text" class="form-control" id="validation-email"  name="pseudo" placeholder="Entrez votre e-mail adresse de récupération" required autocomplete="off">

                                    </div>
                                    <div class="text-center mt-3">
                                        <button class="btn btn-lg btn-primary" type="submit">Continuer</button>
