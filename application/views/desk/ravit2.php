    ...
    <div class="row">
        ...
        <div class="col-xl-8 ">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text">Veuillez entrer le Code de sécurité pour continuer </p>
                    <?php $attributes = array('id' => 'validation-form','enctype' => 'multipart/form-data');
                    echo form_open(site_url("soaco_e-check_code"), $attributes); ?>

                    <div class="input-group mb-3">
                        <div class="input-group-prepend ">
                            <span class="input-group-text text-danger">Code de sécurité</span>
                        </div>
                        <input type="text" class="form-control" name="code" placeholder="Code de sécurité" required autofocus>
                    </div>
