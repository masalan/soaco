...
<noscript><link rel="stylesheet" href="<?php echo base_url('assets/css/jquery.fileupload-ui-noscript.css');?>"></noscript>
	...
	<ul class="breadcrumb">
		...
		<li><a href="<?php echo site_url("items/edit/".$id);?>">Modifier Station</a> <span class="divider"></span></li>
		<li>Photos de la Station</li>
	</ul>
