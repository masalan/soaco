...
<!--				<table class="table table-striped table-bordered">-->
                <table id="datatables-basic" class="table table-striped" style="width:100%">  <!---fort Boostsrap 4+ --->
                <tr>
					...
					?>
							<tr>
								...
								<?php if(in_array('edit',$allowed_accesses)):?>
									<td><a href='<?php echo site_url("responsable/".url_encode($user->user_id));?>'><i class='glyphicon glyphicon-edit'></i></a></td>
								<?php endif;?>
					...
					?>
							<tr>
								...
								Aucun Reponsable de commune disponible
								</td>
							</tr>
					<?php
						endif;
