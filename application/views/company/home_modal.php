                            ...
                            <div class="list-group-item">
                                ...
                                <div class="list-group-item-figure">
                                    <?php if($item->is_published == 1):?>
                                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('company/desactif/').$item->id ;?>">Desactive</a>
                                    <?php else:?>
                                        <a  class="btn btn-sm  btn-warning" href="<?php echo base_url('company/actif/').$item->id ;?>">Actif</a>
                                    <?php endif;?>
...
<div class="modal fade" id="listMessageModal" tabindex="-1" role="dialog" aria-labelledby="followingModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    if(isset($msg) && count($msg->result())>0):
                        foreach($msg->result() as $ms):
                            ...
                            <div class="list-group-item">
                                ...
                                <div class="list-group-item-figure">
                                    <?php if($ms->is_read == 1):?>
                                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('company/unread/').$ms->id ;?>">Lu</a>
                                    <?php elseif($ms->is_read == 0):?>
                                        <a  class="btn btn-sm  btn-warning" href="<?php echo base_url('company/read/').$ms->id ;?>">Non Lu</a>
                                    <?php endif;?>
                                </div>
                            </div>
                        ...
                        <div class="list-group-item">
                            ...
                            <div class="list-group-item-body">
                                <p class="list-group-item-text">Aucun message </p>
                            </div>
