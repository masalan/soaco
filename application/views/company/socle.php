        ...
        <div class="page has-sidebar has-sidebar-fluid has-sidebar-expand-xl">
            ...
            <div class="page-inner page-inner-fill position-relative">
                <header class="page-navs bg-light shadow-sm">
                    ...
                    <div class="input-group has-clearable">
                        ...
                        <input type="text" class="form-control" id="searchClients" data-filter=".board .list-group-item" placeholder="trouver une station">
                    </div><!-- /.input-group -->
                </header>
                <button type="button" class="btn btn-primary btn-floated position-absolute" data-toggle="modal" data-target="#clientNewModal" title="Add new client"><i class="fa fa-plus"></i></button> <!-- board -->
                <div class="board p-0 perfect-scrollbar">
                    ...
                    <div class="list-group list-group-flush list-group-divider border-top" data-toggle="radiolist">
                        ...
                        <div class="list-group-item active" data-toggle="sidebar" data-sidebar="show">
                            <a href="page-clients.html#" class="stretched-link"></a>
                            <div class="list-group-item-figure">
                                <div class="tile tile-circle bg-blue"> Z </div>
                            </div>
                            <div class="list-group-item-body">
                                <h4 class="list-group-item-title"><?php echo $this->db->get_where('cd_cities',array('id'=>$city_id))->row()->name;?></h4>
                                <p class="list-group-item-text"> brSan Francisco, United States </p>
                            </div>
                        </div>
            ...
            <div class="page-sidebar bg-light">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active">
                                <a href="page-clients.html#" onclick="Looper.toggleSidebar()"><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Back</a>
                            </li>
                        </ol>
                    </nav>
                ...
                <div class="sidebar-section sidebar-section-fill">
                    <h1 class="page-title">
                        <i class="far fa-building text-muted mr-2"></i><?php echo $this->db->get_where('cd_cities',array('id'=>$city_id))->row()->name;?></h1>
                    <p class="text-muted">  <?php echo $this->city->get_current_country()->name;?> </p><!-- .nav-scroller -->
                    ...
                    <div class="section-block">
                        ...
                        <div class="metric-row metric-flush">
                            ...
                            <div class="col">
                                <!-- .metric -->
                                <a  class="metric metric-bordered align-items-center" data-toggle="modal" data-target="#listStationModal">
                                    <h2 class="metric-label"> Stations </h2>
                                    <p class="metric-value h3">
                                        <sub><i class="oi oi-people"></i></sub> <span class="value"><?php echo $this->item->count_all_station_company($company_id,$city_id);?></span>
                                    </p>
                                </a> <!-- /.metric -->
                            </div><!-- /metric column -->
                            <!-- metric column -->
                            <div class="col">
                                <!-- .metric ici  -->
                                <a href="<?php echo base_url('zone_details/').url_encode($city_id);?>" class="metric metric-bordered align-items-center">
                                    <h2 class="metric-label"> Gérants </h2>
                                    <p class="metric-value h3">
                                        <sub><i class="oi oi-fork"></i></sub> <span class="value"><?php echo $this->item->count_all_gerant_company($company_id,$city_id);?></span>
                                    </p>
                                </a> <!-- /.metric -->
                            </div><!-- /metric column -->
                            <!-- metric column -->
                            <div class="col">
                                <!-- .metric -->
                                    <a  class="metric metric-bordered align-items-center" data-toggle="modal" data-target="#messageNonLuModal">
                                    <h2 class="metric-label">Messages non lu</h2>
                                    <p class="metric-value h3">
                                        <sub><i class="oi oi-timer fa-lg"></i></sub> <span class="value"><?php echo $this->item->count_all_msg_company($company_id,$city_id);?></span>
                                    </p>
                                </a> <!-- /.metric -->
                            </div><!-- /metric column -->
                        </div><!-- /.metric-row -->
                    ...
                    <div class="nav-scroller border-bottom">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link active show" data-toggle="tab" href="<?php echo base_url('zone_details/').url_encode($this->user->get_logged_in_user_info()->user_id);?>#client-billing-contact">Billing & Contact</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#client-tasks"  aria-controls="client-tasks" >To Do</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#client-projects"  aria-controls="client-projects" >Projects</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#client-invoices"  aria-controls="client-invoices" >Invoices</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#client-expenses"  aria-controls="client-expenses" >Expenses</a>
                            </li>
                        </ul><!-- /.nav-tabs -->
                    </div><!-- /.nav-scroller -->
                    <!-- .tab-content -->
                    <div class="tab-content pt-4" id="clientDetailsTabs">
                        ...
                        <div class="tab-pane fade show active" id="client-billing-contact" role="tabpanel" aria-labelledby="client-billing-contact-tab">
                            ...
                            <div class="card mt-4">
                                ...
                                <div class="card-footer">
                                    <a href="<?php echo base_url('zone_details/').url_encode($this->user->get_logged_in_user_info()->user_id);?>#clientContactNewModal" class="card-footer-item" data-toggle="modal"><i class="fa fa-plus-circle mr-1"></i> Add contact</a>
                                </div><!-- /.card-footer -->
                            </div><!-- /.card -->
                        </div><!-- /.tab-pane -->
                        <!-- .tab-pane -->
                        <div class="tab-pane fade" id="client-tasks" role="tabpanel" aria-labelledby="client-tasks-tab">
                            ...
                            <div class="card">
                                ...
                                <!-- .card-footer -->
                                <div class="card-footer">
                                    <a href="<?php echo base_url('zone_details/').url_encode($this->user->get_logged_in_user_info()->user_id);?>#" class="card-footer-item"><i class="fa fa-plus-circle mr-1"></i> Add todo</a>
                                </div><!-- /.card-footer -->
                            </div><!-- /.card -->
                            <!-- .card -->
                            <div class="card">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td class="align-middle text-truncate">
                                                <a href="<?php echo base_url('zone_details/').url_encode($this->user->get_logged_in_user_info()->user_id);?>#" class="tile bg-pink text-white mr-2">SP</a> <a href="<?php echo base_url('zone_details/').url_encode($this->user->get_logged_in_user_info()->user_id);?>#">Syrena Project</a>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="align-middle text-truncate">
                                                <a href="page-clients.html#" class="tile bg-green text-white mr-2">MG</a> <a href="page-clients.html#">Mobile App Gex</a>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="align-middle text-truncate">
                                                <a href="page-clients.html#" class="tile bg-red text-white mr-2">LB</a> <a href="page-clients.html#">Landing Page Booster</a>
                                            </td>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td class="align-middle text-truncate">
                                                <div class="media align-items-center">
                                                    <a href="page-clients.html#" class="tile bg-pink text-white mr-2">SP</a>
                                                    <div class="media-body">
                                                        <a href="page-clients.html#">Syrena Project</a> <small class="d-block text-muted">Invoice #9463</small>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="align-middle text-truncate">
                                                <div class="media align-items-center">
                                                    <a href="page-clients.html#" class="tile bg-purple text-white mr-2">BA</a>
                                                    <div class="media-body">
                                                        <a href="page-clients.html#">Mobile App Gex</a> <small class="d-block text-muted">Invoice #0754</small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="align-middle"></td>
                                        ...
                                        <tr>
                                            <td class="align-middle text-truncate">
                                                <div class="media align-items-center">
                                                    <a href="page-clients.html#" class="tile bg-teal text-white mr-2">SB</a>
                                                    <div class="media-body">
                                                        <a href="page-clients.html#">SVG Icon Bundle</a> <small class="d-block text-muted">Invoice #8613</small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="align-middle">
                                        ...
                                        <tr>
                                            <td class="align-middle text-truncate">
                                                <div class="media align-items-center">
                                                    <a href="page-clients.html#" class="tile bg-red text-white mr-2">LB</a>
                                                    <div class="media-body">
                                                        <a href="page-clients.html#">Landing Page Booster</a> <small class="d-block text-muted">Invoice #9458</small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="align-middle"></td>
...
<?php echo $this->load->view('company/list_msg'); ?>
